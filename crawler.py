                        ...
                        if now - date_time > threshold:
                            ...
                            try:
                                ...
                                if len(video_id) == 0:
                                    ...
                                    update_sql = f"UPDATE zt_author_data SET drama_id={ju_id},playlet_name='{clean_text}', update_time = '{now_date}', comment_count = {comment_count},digg_count = {digg_count}, collect_count = {collect_count}, three_comment_count = {new_comment_count}, three_digg_count = {new_digg_count},three_collect_count = {new_collect_count} WHERE id = {up_id}"
